...
//     <section 
//       ref={sectionRef}
//       className="relative section-padding overflow-hidden bg-gradient-to-b from-[#0F0F0F] to-[#1A1A1A] dark:from-[#0F0F0F] dark:to-[#1A1A1A] light:from-gray-50 light:to-gray-100"
//     >
//       {/* ✅ OPTIMIZED: Background Pattern - responsive */}
//       <div className="absolute inset-0 opacity-5">
//         <div 
...
//           <h2 className="px-4 mb-3 text-xl md:mb-4 heading-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
//             Pakistan's Most <span className="gradient-text">Trusted</span> Software House
//           </h2>
          
//           <p className="max-w-2xl px-4 mx-auto text-sm leading-relaxed md:max-w-3xl md:text-base lg:text-lg xl:text-xl">
//             We don't just build software — we build lasting partnerships with enterprises 
//             that shape Karachi's digital future.
//           </p>
//         </motion.div>
...
//               <h3 className="mb-1 text-base font-medium md:mb-2 md:text-lg lg:text-xl">
//                 {stat.label}
//               </h3>
...
//                     ✓
//                   </div>
//                   <div className="mb-1 text-base font-medium md:mb-2 md:text-lg lg:text-xl">
//                     {item.metric}
//                   </div>
...
//             whileInView={{ opacity: 1, y: 0 }}
//             viewport={{ once: true }}
//             className="mb-6 text-xl md:mb-8 lg:mb-10 md:text-2xl lg:text-3xl xl:text-4xl font-display"
//           >
//             <span className="gradient-text">Premium Partners</span> We've Served
//           </motion.h3>
...
//                         <div className="relative p-3 transition-all duration-300 border rounded-lg md:p-4 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm border-white/10 hover:border-accent/30">
//                           {/* Partner Name */}
//                           <div className="text-base transition-colors duration-300 md:text-lg lg:text-xl font-display group-hover:text-accent">
//                             {partner.name}
//                           </div>
...
//             }}
//             transition={{ duration: 3, repeat: windowWidth >= 768 ? Infinity : 0 }}
//             className="px-4 text-base italic font-light leading-relaxed md:text-lg lg:text-xl xl:text-2xl"
//           >
//             "ZENO didn't just deliver a product — they became our technology partners. 
//             Their deep understanding of Karachi's business landscape is unparalleled."
//           </motion.p>
...
//           <div className="mt-4 md:mt-5 lg:mt-6">
//             <div className="text-base font-medium md:text-lg lg:text-xl">
//               Ali Raza
//             </div>
//             <div className="mt-0.5 md:mt-1 text-xs md:text-sm text-accent">
//               CTO · Leading Karachi Enterprise
...
//               className="absolute hidden top-20 right-10 lg:block"
//             >
//               <div className="p-3 border rounded-lg lg:p-4 bg-black/50 dark:bg-black/50 light:bg-white/80 backdrop-blur-sm border-accent/20">
//                 <div className="text-lg lg:text-xl xl:text-2xl text-accent font-display">98%</div>
//                 <div className="text-[10px] lg:text-xs">Client Retention</div>
//               </div>
//             </motion.div>
...
//               <div className="p-3 border rounded-lg lg:p-4 bg-black/50 dark:bg-black/50 light:bg-white/80 backdrop-blur-sm border-accent/20">
//                 <div className="text-lg lg:text-xl xl:text-2xl text-accent font-display">50+</div>
//                 <div className="text-[10px] lg:text-xs">Projects</div>
//               </div>
//             </motion.div>
//           </>
//         )}
    ...
    >
      ...
      <div className="relative z-10 px-4 container-custom sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="px-4 mb-3 text-2xl text-white dark:text-white light:text-gray-900 md:mb-4 heading-lg sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
            Pakistan's Most <span className="gradient-text">Trusted</span> Software House
          </h2>
          
          <p className="max-w-2xl px-4 mx-auto text-sm leading-relaxed text-gray-300 dark:text-gray-300 light:text-gray-600 md:max-w-3xl md:text-base lg:text-lg xl:text-xl">
            We don't just build software — we build lasting partnerships with enterprises 
            that shape Karachi's digital future.
          </p>
        </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              variants={itemVariants}
              whileHover={{ y: windowWidth < 768 ? -3 : -5 }}
              className="relative p-4 transition-all duration-500 border rounded-lg md:p-5 lg:p-6 xl:p-8 group bg-white/5 dark:bg-white/5 light:bg-white backdrop-blur-sm border-white/10 dark:border-white/10 light:border-gray-200 hover:border-accent/30 md:rounded-xl"
            >
              <motion.div
                className="absolute inset-0 transition-opacity duration-500 rounded-lg opacity-0 bg-gradient-to-br from-accent/5 to-transparent group-hover:opacity-100 md:rounded-xl"
                initial={false}
              ...
              <h3 className="mb-1 text-base font-medium text-white dark:text-white light:text-gray-900 md:mb-2 md:text-lg lg:text-xl">
                {stat.label}
              </h3>
              
              <p className="text-xs text-gray-400 dark:text-gray-400 light:text-gray-600 md:text-sm">
                {stat.description}
              </p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-5 lg:gap-6">
              {trustIndicators.map((item, index) => (
                ...
                >
                  ...
                  <div className="mb-1 text-base font-medium text-white dark:text-white light:text-gray-900 md:mb-2 md:text-lg lg:text-xl">
                    {item.metric}
                  </div>
                  <div className="text-xs text-gray-400 dark:text-gray-400 light:text-gray-600 md:text-sm">
                    {item.description}
                  </div>
                </motion.div>
              ))}
        ...
        >
          <motion.h3 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mb-6 text-xl text-white dark:text-white light:text-gray-900 md:mb-8 lg:mb-10 md:text-2xl lg:text-3xl xl:text-4xl font-display"
          >
            <span className="gradient-text">Premium Partners</span> We've Served
          </motion.h3>
                  ...
                  {partners
                    ...
                    .map((partner, index) => (
                      <motion.div
                        ...
                        className="cursor-default group"
                      >
                        <div className="relative p-3 transition-all duration-300 border rounded-lg md:p-4 bg-white/5 dark:bg-white/5 light:bg-white backdrop-blur-sm border-white/10 dark:border-white/10 light:border-gray-200 hover:border-accent/30">
                          <div className="text-base text-white transition-colors duration-300 dark:text-white light:text-gray-900 md:text-lg lg:text-xl font-display group-hover:text-accent">
                            {partner.name}
                          </div>
                          
                          <div className="mt-1 text-[10px] text-gray-400 dark:text-gray-400 light:text-gray-600 md:text-xs">
                            {partner.category}
                          </div>
                          ...
                          <motion.div 
                            initial={{ opacity: 0, scale: 0 }}
                            whileHover={{ opacity: 1, scale: 1 }}
                            className="absolute -top-1 -right-1 md:-top-2 md:-right-2 px-1.5 md:px-2 py-0.5 md:py-1 text-[8px] md:text-xs rounded-full bg-accent text-white"
                          >
                            since {partner.since}
                          </motion.div>
        ...
        >
          ...
          <motion.p 
            ...
            transition={{ duration: 3, repeat: windowWidth >= 768 ? Infinity : 0 }}
            className="px-4 text-base italic font-light leading-relaxed text-gray-300 dark:text-gray-300 light:text-gray-700 md:text-lg lg:text-xl xl:text-2xl"
          >
            "ZENO didn't just deliver a product — they became our technology partners. 
            Their deep understanding of Karachi's business landscape is unparalleled."
          </motion.p>
          ...
          <div className="mt-4 md:mt-5 lg:mt-6">
            <div className="text-base font-medium text-white dark:text-white light:text-gray-900 md:text-lg lg:text-xl">
              Ali Raza
            </div>
            <div className="mt-0.5 md:mt-1 text-xs md:text-sm text-accent">
              CTO · Leading Karachi Enterprise
          ...
          >
            ...
            <span className="text-[10px] text-gray-400 dark:text-gray-400 light:text-gray-600 md:text-xs lg:text-sm">
              5.0 · 25+ reviews on Clutch
            </span>
          </motion.div>
        </motion.div>
        ...
        {windowWidth >= 1024 && (
          <>
            ...
            >
              <div className="p-3 border rounded-lg lg:p-4 bg-black/50 dark:bg-black/50 light:bg-white/80 backdrop-blur-sm border-accent/20">
                <div className="text-lg lg:text-xl xl:text-2xl text-accent font-display">98%</div>
                <div className="text-[10px] text-gray-400 dark:text-gray-400 light:text-gray-600 lg:text-xs">Client Retention</div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-3 border rounded-lg lg:p-4 bg-black/50 dark:bg-black/50 light:bg-white/80 backdrop-blur-sm border-accent/20">
                <div className="text-lg lg:text-xl xl:text-2xl text-accent font-display">50+</div>
                <div className="text-[10px] text-gray-400 dark:text-gray-400 light:text-gray-600 lg:text-xs">Projects</div>
              </div>
            </motion.div>
          </>
        )}
